...
class VideoFragmentOld : BaseMvpFragment<VideoFragmentView, VideoFragmentPresenter>(), VideoFragmentView {
    ...
    companion object {
        ...
        fun newInstance() = VideoFragmentOld()
    }
    ...
    fun connectToDevice(uuid: String) {
        getPresenter().offerDevice(uuid)
    }

    override fun createOffer() {
        getPresenter().listenForIceCandidates()
        peer.createOffer(object : SdpObserver {
            ...
            override fun onSetSuccess() {
                ...
                getPresenter().sendOffer(localDescription)
